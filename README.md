# Civil Security scripts

These scripts are used to install certain interactive stations in the Civil Security project.

# Installation

## Kiosk OS

The target system for running the script is Ubuntu 24.04.4+ provided that the following settings have been applied during installation:
...
```
wget https://raw.githubusercontent.com/IMAGINARY/civil-security-scripts/main/bin/bootstrap-os
